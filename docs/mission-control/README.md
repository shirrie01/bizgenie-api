...
| BG-LAUNCH-002I-C | In progress on branch `bg-launch-002i-c-preview-registry`; customer preview submit/render/acknowledge/approve flow is being added through a trusted preview registry without external platform rendering, publishing, billing or deployment scope |
| Contract and evidence | [Canonical campaign spine](../launch/CAMPAIGN_SPINE_CONTRACT.md), [acceptance and handoff](../launch/CAMPAIGN_SPINE_ACCEPTANCE.md), [I-A evidence](../launch/CAMPAIGN_SPINE_EVIDENCE.md), [I-B evidence](../launch/CAMPAIGN_SPINE_PERSISTENCE_EVIDENCE.md), [I-F evidence](../launch/CAMPAIGN_CUSTOMER_API_EVIDENCE.md), [I-C evidence](../launch/CAMPAIGN_PREVIEW_REGISTRY_EVIDENCE.md) |
| Exact restart point | Continue BG-LAUNCH-002I-C from merged main `e112b5d0d28758579ede2fde88751d043b2c3aa0`. Verify preview registry receipt, acknowledgement and approval coverage before any review/merge decision. No shared staging deployment, publishing connector or billing action is authorized by this checkpoint |
