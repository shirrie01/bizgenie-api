-- BG-COM-002: fix PL/pgSQL output-column ambiguity in the Paid-Beta v1
-- provisioning function. This is a forward-only function replacement; it
-- does not change pricing, entitlement economics, identifiers, or ledger
-- authority.
