...
describe("campaign generation composed authorization", () => {
  it("passes full approved brand generation authorization into the real GenerationJobService", async () => {
    ...
    const app = createApp({
      ...
      scriptGenerator: async () => ({ text: "Fonzo launch copy", metadata: { selected_strategy: { angle: "Audience-led launch", evidence_anchors: ["Launch Fonzo in the UK"], specificity: "Uses the campaign goal", platform_execution: "Native post" }, strategy_candidates: [{ angle: "Audience-led launch", evidence_anchors: ["Launch Fonzo in the UK"], specificity: "Uses the campaign goal", platform_execution: "Native post" }, { angle: "UK launch availability story", evidence_anchors: ["Launch Fonzo in the UK"], specificity: "Uses UK launch context", platform_execution: "Native carousel" }, { angle: "Founder launch context", evidence_anchors: ["Launch Fonzo in the UK"], specificity: "Uses campaign objective", platform_execution: "Native story" }], selection_evidence: { selected_candidate_index: 0, criteria: ["brand_truth", "platform_fit"], rationale: "Selected for the strongest supported campaign and platform fit." } } }),
    });
